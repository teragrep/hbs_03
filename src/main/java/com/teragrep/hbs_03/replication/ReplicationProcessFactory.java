...
public final class ReplicationProcessFactory implements Factory<ReplicationProcess> {

    private static final Logger LOGGER = LoggerFactory.getLogger(ReplicationProcessFactory.class);

    private final Configuration config;
    private final String prefix;

    public ReplicationProcessFactory(final Configuration config) {
        this(config, "hbs.");
    }

    public ReplicationProcessFactory(final Configuration config, final String prefix) {
        this.config = config;
        this.prefix = prefix;
    }

    @Override
    public ReplicationProcess object() {
