 ...
 */
public final class LogfileTableIdRangeQuery {

    private static final Logger LOGGER = LoggerFactory.getLogger(LogfileTableIdRangeQuery.class);

    private final DSLContext ctx;
    private final ULong startId;
    private final ULong endId;

    public LogfileTableIdRangeQuery(final DSLContext ctx, final long startId, final long endId) {
        this(ctx, ULong.valueOf(startId), ULong.valueOf(endId));
    }

    public LogfileTableIdRangeQuery(final DSLContext ctx, final ULong startId, final ULong endId) {
        this.ctx = ctx;
