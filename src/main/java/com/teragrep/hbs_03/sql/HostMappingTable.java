...
public class HostMappingTable {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(HostMappingTable.class);

    private final DSLContext ctx;
    private final String name;

    public HostMappingTable(final DSLContext ctx) {
        this(ctx, "host_mapping_temp_table");
    }

    public HostMappingTable(final DSLContext ctx, final String name) {
        this.ctx = ctx;
        this.name = name;
    }
